    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 text-gray-700 font-medium">
          ...
          <a href="#" className="hover:text-red-600 duration-200">Added Dishes</a>
         
          <a href="#" className="hover:text-red-600 duration-200">HElp</a>
           <Link  to="/login" className="hover:text-red-600 duration-200">logout</Link>
  </nav>
