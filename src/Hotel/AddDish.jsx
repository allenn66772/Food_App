...
function AddDish() {
  ...
  const handleAddFood = async () => {
    const { name, price, category,  descryption, uploadImages } =
      foodDetails;
    if (
      !name ||
      !price ||
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
          <header className="mb-6">
            ...
            <p className="text-sm text-gray-500">
              Fill in the food details and upload an appetizing image.
            </p>
          </header>
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  ...
                  className="px-5 py-3 bg-blue-600 text-white rounded-lg shadow hover:brightness-105 transition"
                >
                  Publish Food
                </button>
            ...
            <aside className="flex flex-col items-center justify-start gap-4 p-4 border border-gray-100 rounded-lg bg-gray-50">
              <div className="w-full">
                <div className="w-full">
                  <label className="block">
                    <div
                      className="h-48 w-full rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 
                ...
                <div className="mt-3 text-xs text-gray-500">
                  Recommended: 800×600px, JPG/PNG, max 2MB
                </div>
              </div>
              ...
              <div className="w-full">
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1 text-sm border border-gray-200 rounded bg-white">
                      Remove
                    </button>
                    <button className="px-3 py-1 text-sm border border-gray-200 rounded bg-white">
                      Replace
          ...
          <footer className="mt-6 text-xs text-gray-400">
            Preview shown above is static — this is a design-only layout.
          </footer>
        </div>
      </div>
    </>
