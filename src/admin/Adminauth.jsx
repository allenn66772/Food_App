...
function Adminauth({register}) {
  ...
  return (
    ...
    <div className='w-full min-h-screen rounde flex justify-center items-center flex-col bg-cover bg-center'>
        <div className='p-10'>
          <h1 className='text-3xl font-extrabold text-white text-center'>Login as Admin</h1>
          <div style={{ width: "400px" }} className='bg-red-700 text-white hover:shadow-[0_0_20px_blue] p-5 flex rounded-3xl flex-col my-5 justify-center items-center '>
            ...
            <form action="">
              ...
              <div className='mt-3'>
                  ...
                  {register ? <p>Are you Already a user <Link className='text-blue-400' to={"/user-login"} >Login</Link> </p>:
